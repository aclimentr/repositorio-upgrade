...
//   const elementos = miCamino.material[i];
//   if(i == 0){
//     console.log(`Lo primero que debo llevar es ${elementos.nombre} y es ${elementos.descripcion}`)
//   }
//   if(i == 1){
//     console.log(`Lo segundo que debo llevar es ${elementos.nombre} y es ${elementos.descripcion}`)
//   }
//   if(i == 2){
//     console.log(`Lo tercero que debo llevar es ${elementos.nombre} y es ${elementos.descripcion}`)
//   }
//   if(i == 3){
//     console.log(`Lo último que debo llevar es ${elementos.nombre} y es ${elementos.descripcion}`)
//   }
...
//5º: vamos a decir: para subir al {nombre de la cima}  debo subir {altitud } metros y debo viajar a {ubicacion}

  // for (let i = 0; i < miCamino.cimas.length; i++) {
  //   const cima1 = miCamino.cimas[i];
  //   console.log(`para subir al ${cima1.nombre} debo subir ${cima1.altitud} metros y debo viajar a ${cima1.localizacion}`)
  // }

  // for (const cima1 of miCamino.cimas) {
  //   console.log(`Para subir al ${cima1.nombre} debo subir ${cima1.altitud} metros y debo viajar a ${cima1.localizacion}`);
  // }
